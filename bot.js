...
// Replace this with a websocket connection to your alchemy node to monitor mainnet
const web3 = new Web3('ws://127.0.0.1:7545') // dev
...
// How much WETH are you willing to spend on new tokens?
const AMOUNT = '0.25' 
// 5% Slippage
// In prod, reduce slippage by using a higher gas fee and/or a Layer 2 framework
const SLIPPAGE = 0.05 
